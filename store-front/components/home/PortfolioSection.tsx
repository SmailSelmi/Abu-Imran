  ...
  const displayBreeds =
    initialProducts.length > 0
      ? initialProducts.map((p) => ({
          ...
          name:
            p.name ||
            (isRTL ? p.breed?.name_ar : p.breed?.name_en) ||
            p.name_en,
        ...
        <div className="flex flex-col md:flex-row items-baseline justify-between mb-24 gap-12">
          <div className="max-w-3xl space-y-8">
            ...
            >
              ...
              <span className="text-primary italic ps-4">
                    ...
                    <div className="w-14 h-14 rounded-full bg-white text-zinc-950 flex items-center justify-center shadow-sm border border-border/40 scale-0 group-hover:scale-100 transition-transform delay-100">
                      <ArrowUpRight
                        className={cn(
                          ...
                          isRTL ? "rotate-180" : "group-hover:rotate-45",
                        )}
                      />
                    </div>
                  </div>
