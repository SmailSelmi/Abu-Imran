    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-muted-foreground font-black">
            إدارة جميع منتجات المزرعة وتتبع مستويات التوفر.
          </p>
        </div>
        ...
        >
          <CardHeader className="flex flex-row items-center justify-between p-8">
            <CardTitle className="text-xl font-black">
              {editingId ? "تعديل المنتج" : "إضافة مادة جديدة"}
            </CardTitle>
            <Button
              variant="ghost"
              size="icon"
      ...
      <Card className="border border-border/40 shadow-sm rounded-xl bg-white dark:bg-card overflow-hidden">
        <CardHeader className="p-8 pb-4">
          <CardTitle className="text-xl font-black">
            المخزون الحالي ({products.length})
          </CardTitle>
        </CardHeader>
