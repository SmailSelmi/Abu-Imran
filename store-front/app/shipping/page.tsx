      ...
      <div className="max-w-3xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            نحن في مزرعة أبو عمران نحرص على توصيل طلباتكم بأمان وسرعة إلى كافة
            الولايات المتاحة.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              نغطي التوصيل لـ 58 ولاية جزائرية. تختلف مدة الشحن والتكلفة حسب
              الولاية والمسافة من مقر المزرعة.
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground leading-relaxed">
              نولي اهتماماً خاصاً عند شحن البيض المخصب والكتاكيت. يتم استخدام
              عبوات مخصصة تحافظ على درجة الحرارة والرطوبة وتقلل من الاهتزازات
              لضمان وصولها بحالة ممتازة وجاهزة.
            </p>
          </section>
