import { ShieldCheck, Egg, Thermometer, Truck, Phone, Award } from 'lucide-react'
      ...
      <div className="container px-4 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, i) => (
                <div key={i} className="flex gap-4 p-8 rounded-xl bg-muted/30 border border-transparent hover:border-green-500/30 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
