  ...
  return (
    <section className="py-24 bg-white dark:bg-zinc-950" dir="rtl">
      <div className="container px-4 mx-auto">
        ...
        >
          <span className="text-emerald-600 font-bold tracking-wider text-[10px] uppercase bg-emerald-100 dark:bg-emerald-900/30 px-4 py-1.5 rounded-full border border-emerald-200 dark:border-emerald-800/50 opacity-80">
            اكتشف منتجاتنا
          </span>
              ...
              <Link href={cat.link} className="group relative block h-full">
                ...
                <Card className="h-full relative overflow-hidden border-border/50 bg-background/50 backdrop-blur-sm hover:border-emerald-500/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-md rounded-xl">
                  <CardContent className="p-8 text-center space-y-6 flex flex-col items-center h-full">
                    <div
                      className={`w-24 h-24 rounded-full bg-${cat.color}-100/50 dark:bg-${cat.color}-900/20 flex items-center justify-center text-${cat.color}-600 dark:text-${cat.color}-400 group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300 shadow-inner`}
                    >
                      <cat.icon className="w-12 h-12" />
                    </div>
                    <div className="space-y-3 flex-grow">
                      <h3 className="text-2xl font-black tracking-tight group-hover:text-emerald-600 transition-colors uppercase">
                        {cat.name}
                      </h3>
                      <p className="text-muted-foreground leading-relaxed font-bold text-sm opacity-60">
                        {cat.desc}
                      </p>
                    </div>
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          className="absolute -bottom-[20%] -left-[10%] w-[60%] h-[60%] bg-amber-500/5 rounded-full blur-[120px] animate-pulse"
      ...
      <div className="container relative z-10 px-4 mx-auto">
          ...
          {[
            ...
            >
              <div className="h-full p-8 rounded-[2.5rem] bg-white/5 border border-white/10 backdrop-blur-xl hover:bg-white/[0.08] hover:border-white/20 transition-all duration-500 flex flex-col items-center text-center space-y-6">
                ...
                <div
                  className={`w-24 h-24 rounded-3xl bg-neutral-800 p-0.5 shadow-sm border border-border/20 group-hover:scale-110 transition-transform duration-500`}
                >
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-gray-400 font-bold text-sm leading-relaxed opacity-80">
                    {step.desc}
                  </p>
                </div>
              </div>
        ...
        >
          ...
          >
            <Button
              size="lg"
              className="bg-emerald-500 hover:bg-emerald-400 text-black font-black text-xl px-12 h-20 rounded-2xl shadow-sm hover:shadow hover:-translate-y-2 transition-all duration-300 group"
            >
