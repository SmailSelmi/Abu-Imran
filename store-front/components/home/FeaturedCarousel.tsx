...
export default function FeaturedCarousel() {
  ...
  return (
    <section className="py-16 md:py-24 bg-white dark:bg-black overflow-hidden" dir="rtl">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 mb-12">
                <div className="text-center md:text-start space-y-2">
                    <div className="flex items-center justify-center md:justify-start gap-2 text-emerald-600 mb-2">
                        ...
                        <span className="text-xs font-black uppercase tracking-widest opacity-80">اكتشف منتجاتنا</span>
                    </div>
                    <h2 className="text-3xl md:text-5xl font-black tracking-tighter">تسوق حسب الفئة</h2>
                </div>
            </div>
                        ...
                        <div className="group block relative h-full">
                            <div className="h-full p-6 md:p-8 rounded-2xl bg-white dark:bg-zinc-950 border border-border/40 transition-all duration-500 hover:border-emerald-500/30 group-hover:-translate-y-1">
                                ...
                                <div className="space-y-2">
                                    <h3 className="text-xl md:text-2xl font-black tracking-tighter transition-colors group-hover:text-emerald-600 uppercase">{cat.name}</h3>
                                    <p className="text-xs md:text-sm text-muted-foreground font-medium italic opacity-70 leading-relaxed">{cat.desc}</p>
                                </div>
                                <div className="mt-6 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-emerald-600 opacity-60 group-hover:opacity-100 transition-opacity">
                                    اطلب الآن <ArrowRight className="w-3 h-3 rotate-180 group-hover:-translate-x-1 transition-transform" />
                                </div>
                            </div>
                        </div>
                    </motion.div>
