...
export function OrderDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-4xl p-0 overflow-hidden border border-border/40 rounded-3xl bg-white dark:bg-zinc-950 shadow-2xl">
              ...
              <div className="md:w-72 bg-emerald-950 text-white p-6 space-y-6 relative overflow-hidden shrink-0 flex flex-col">
                ...
                <div className="relative z-10 space-y-5 flex-grow">
                  ...
                  <div className="space-y-3 pt-3">
                    <div className="p-3 rounded-xl bg-white/5 border border-white/10 flex items-center gap-3">
                      ...
                      <p className="text-xs font-bold leading-tight uppercase tracking-widest opacity-80">
                ...
                <div className="relative z-10 pt-5 border-t border-white/10 mt-auto">
                  <div className="space-y-1">
                    <p className="text-[10px] font-black uppercase tracking-[0.3em] text-emerald-400 opacity-60">
                      المجموع المقدر
                    </p>
                    <p className="text-4xl font-black tracking-tighter text-amber-400 leading-none">
                      ...
                      <span className="text-sm font-bold opacity-80">د.ج</span>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <Controller
                        ...
                        render={({ field }) => (
                          <Select
                            ...
                            value={field.value}
                          >
                            <SelectTrigger className="h-12 rounded-xl font-bold border-2 border-border/50 bg-white dark:bg-zinc-900 focus:ring-emerald-500">
                              <SelectValue placeholder="اختر..." />
                            </SelectTrigger>
                            <SelectContent className="rounded-xl border-2 dark:bg-zinc-950">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        className="h-12 rounded-xl font-black text-xl border-2 border-emerald-200 dark:border-emerald-500/30 text-center bg-emerald-50/50 dark:bg-emerald-500/10 text-emerald-900 dark:text-emerald-50 focus-visible:ring-emerald-500"
                      />
                      {errors.quantity && (
                        <p className="text-xs text-red-500 font-bold mt-1">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="h-12 rounded-xl font-bold bg-zinc-50 dark:bg-zinc-900 border-border/50 focus-visible:ring-emerald-500"
                        />
                        {errors.name && (
                      ...
                      <div className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="h-12 rounded-xl font-bold bg-zinc-50 dark:bg-zinc-900 border-border/50 focus-visible:ring-emerald-500 tracking-widest"
                          dir="ltr"
                        />
                        {errors.phone && (
                          <p className="text-xs text-red-500 font-bold">
                        ...
                        <Controller
                          ...
                          render={({ field }) => (
                            <Select
                              ...
                              value={field.value}
                            >
                              <SelectTrigger className="h-12 rounded-xl font-bold border-border/50 bg-zinc-50 dark:bg-zinc-900 focus:ring-emerald-500">
                  ...
                  <div className="flex justify-end mt-4">
                    <Button
                      type="submit"
                      disabled={loading}
                      className="h-14 min-h-[56px] w-full rounded-xl bg-emerald-600 hover:bg-emerald-700 font-black text-lg text-white shadow-xl shadow-emerald-500/20 hover:scale-[1.02] transition-all duration-300 group"
                    >
                      {loading ? (
