...
import { Egg, Thermometer, Activity, Clock, ShieldCheck, ChevronRight } from 'lucide-react'
                    ...
                    <div className="space-y-6 lg:space-y-10 order-2 lg:order-1">
                        ...
                        <div className="grid grid-cols-2 gap-3 lg:gap-6">
                            {[
                                ...
                                { icon: ShieldCheck, color: 'purple', label: t.hatching.fullProtection }
                            ].map((item, i) => (
                                <motion.div 
                                    key={i}
                        ...
                        <div className="bg-white dark:bg-zinc-900 rounded-[2.5rem] lg:rounded-[3.5rem] p-6 md:p-10 lg:p-14 shadow-sm border border-border/40 relative z-10">
                            ...
                            <div className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground ps-2 italic">{t.hatching.eggCount}</Label>
                                    <Input 
                                        type="number" 
                                        value={eggCount}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3">
                                        <Label className="text-[11px] font-black uppercase tracking-[0.3em] text-muted-foreground ps-2 italic">{t.hatching.fullName}</Label>
                                        <Input 
                                            value={name}
                                    ...
                                    <div className="space-y-3">
                                        <Label className="text-[11px] font-black uppercase tracking-[0.3em] text-muted-foreground ps-2 italic">{t.hatching.phone}</Label>
                                        <Input 
                                            value={phone}
                                ...
                                <div className="space-y-3">
                                    <Label className="text-[11px] font-black uppercase tracking-[0.3em] text-muted-foreground ps-2 italic">{t.hatching.breedCount}</Label>
                                    <Input 
                                        type="text" 
                                        value={breed}
                                ...
                                <div className="pt-8">
                                    ...
                                    >
                                        <span className="flex items-center gap-4">
                                            ...
                                            <ChevronRight className={cn("w-10 h-10 transition-transform", isRTL ? "rotate-180 group-hover:-translate-x-2" : "group-hover:translate-x-2")} />
                                        </span>
                                    </Button>
                                </div>
