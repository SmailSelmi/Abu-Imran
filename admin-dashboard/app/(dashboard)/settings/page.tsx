    ...
    <div className="space-y-6 max-w-2xl">
      <div>
        ...
        <p className="text-muted-foreground font-black">
          إدارة تفضيلات حسابك وتكوين النظام
        </p>
      </div>
      ...
      <Card className="border border-border/40 shadow-sm rounded-xl bg-white dark:bg-card overflow-hidden">
        ...
        <CardContent>
          <Link href="/settings/zones">
            ...
            >
              <Truck className="ms-3 h-5 w-5 text-emerald-600" /> إعداد مناطق
              التوصيل
            </AnimatedButton>
          </Link>
        </CardContent>
      ...
      <Card className="border border-red-200 dark:border-red-900 shadow-sm rounded-xl bg-red-50 dark:bg-red-950/20 overflow-hidden">
        <CardHeader className="pb-4">
          ...
          <CardDescription className="font-black opacity-80 text-red-800 dark:text-red-300">
            تحذير: هذا الإجراء سيقوم بحذف جميع الطلبيات والإشعارات، وتصفير
            إيرادات النظام. لا يمكن التراجع عن هذا الإجراء.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <AnimatedButton
          ...
          >
            {resetLoading ? (
              ...
              <>
                <TriangleAlert className="ms-3 h-5 w-5" /> مسح بيانات النظام
                والطلبيات
              </>
            )}
          </AnimatedButton>
